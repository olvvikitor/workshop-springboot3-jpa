...
import com.educandoweb.course.reposities.OrderItemRepository;
import com.educandoweb.course.reposities.OrderRepositoy;
import com.educandoweb.course.reposities.ProductRepository;
import com.educandoweb.course.reposities.UserRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.DELIVERD, u1);
